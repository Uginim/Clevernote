...
public interface BoardDAO {
	...
	// 게시글 하나 읽어오기
	BoardVO selectOne(long boardNum);
	// 특정 게시글의 첨부파일 가져오기
	List<AttachmentFileVO> selectAllAttachments(long boardNum);
	// 첨부파일 열기	
	...
	List<BoardVO> selectBoards(long startRowNum, long endRowNum, String searchType, String keyword);	
	// 전체 게시글 수 
...
//	int updateHit(String bnum);
	...
	// 첨부파일 전체 삭제
	int deleteAllAttachments(long boardNum);
