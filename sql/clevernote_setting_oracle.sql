...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ATTACHMENT_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence BOARD_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "BOARD_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CATEGORY_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999 INCREMENT BY 1 START WITH 561 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "USER_SEQUENCE"  MINVALUE 1 MAXVALUE 99999999999 INCREMENT BY 1 START WITH 403 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "COMMENT_CHANGE_HISTORY" 
   (	"COLUMN1" NUMBER, 
	"COLUMN2" NUMBER, 
	"COLUMN3" TIMESTAMP (6) DEFAULT SYSTIMESTAMP
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "COMMENT_CHANGE_HISTORY_PK" ON "COMMENT_CHANGE_HISTORY" ("COLUMN1", "COLUMN2", "COLUMN3") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "COMMENT_CHANGE_HISTORY" ADD CONSTRAINT "COMMENT_CHANGE_HISTORY_PK" PRIMARY KEY ("COLUMN1", "COLUMN2", "COLUMN3")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "COMMENT_CHANGE_HISTORY" MODIFY ("COLUMN3" NOT NULL ENABLE);
  ALTER TABLE "COMMENT_CHANGE_HISTORY" MODIFY ("COLUMN2" NOT NULL ENABLE);
  ALTER TABLE "COMMENT_CHANGE_HISTORY" MODIFY ("COLUMN1" NOT NULL ENABLE);
--------------------------------------------------------
